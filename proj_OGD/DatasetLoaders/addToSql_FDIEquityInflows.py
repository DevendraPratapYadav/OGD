...
datasetPath = "C:\Users\SnehilAmeta\PycharmProjects\proj_OGD\Datasets\FDI_Equity_In_Flows_In_Million_USD.csv";
datasetName = "FDI_Equity_In_Flows_In_Million_USD";
datasetExtension = ".csv";
fancyName = "FDI Equity Inflow (in Million)"
